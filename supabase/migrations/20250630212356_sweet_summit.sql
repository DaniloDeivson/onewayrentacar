/*
  # Fix inspection system and damage cart

  1. Schema Updates
    - Add new columns to inspections table for contract association
    - Add new columns to costs table for customer tracking
    - Add columns to contracts table for additional charges
  
  2. Functions
    - Create function to handle rental checkout process
    - Update damage cost creation to include customer information
