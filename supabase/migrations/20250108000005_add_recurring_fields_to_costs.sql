...
-- Esta migração adiciona os campos necessários para custos recorrentes
...
COMMENT ON COLUMN costs.guest_id IS 'ID do usuário guest associado ao custo';
...
-- Inserir alguns custos recorrentes de exemplo
INSERT INTO costs (
    tenant_id,
    category,
    description,
