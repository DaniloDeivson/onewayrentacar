-- ============================================================================
-- CORREÇÃO DA FUNÇÃO DE VALIDAÇÃO DE QUILOMETRAGEM - SEM ERRO DE RAISE
-- ============================================================================
-- Esta migração corrige o erro na função fn_validate_inspection_mileage
-- removendo o RAISE NOTICE problemático
...
BEGIN
  ...
  IF NEW.mileage < v_current_vehicle_mileage THEN
    ...
    IF v_mileage_difference <= 0.20 THEN
      -- Removido o RAISE NOTICE problemático
      RETURN NEW;
    ELSE
...
BEGIN
  ...
  RAISE NOTICE 'Erro de RAISE NOTICE removido';
END $$; 